def chapter_1_blocks(user_info):
    return [
        {
            "type": "chapter_title",
            "show_in": ["basic", "pro", "diamond"],
            "content": "الفصل الأول - السيناريو الواقعي لمستقبل {نوع_العقار} في {المدينة} خلال العقد القادم"
        },
        {
...
"""
        ...
        {
            "type": "monitoring_indicators",
            "show_in": ["pro", "diamond"],
            "content": """
مؤشرات المراقبة الرئيسية:
1. متوسط مدة بقاء العقار في السوق
