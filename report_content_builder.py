...
بعد هذا التحليل المطوّل، يحتاج القارئ إلى استراحة بصرية
تلخّص الإيقاع العام للسوق دون تعقيد.
"""
        },
        {
            "type": "rich_text",
...
قبل الانتقال للفصل التالي، نعرض لقطة أخيرة
تكسر الإيقاع وتثبّت الفكرة.
"""
        },
        {
            "type": "rich_text",
...
استراحة بصرية وسط تحليل المخاطر الصامتة.
"""
        },
        {
            "type": "rich_text",
...
لقطة أخيرة تلخّص هرم المخاطر قبل الخلاصة.
"""
        },
        {
            "type": "rich_text",
...
استراحة بصرية تظهر المعايير الأربعة بشكل مرئي.
"""
        },
        {
            "type": "rich_text",
...
لقطة ختامية تلخص مراحل الفلتر الخمسة.
"""
        },
        {
            "type": "rich_text",
...
استراحة بصرية تلخص المراحل الأربع للخطة العشرية.
"""
        },
        {
            "type": "rich_text",
...
لقطة تلخّص تذبذب المشاعر عبر مراحل الخطة العشرية.
"""
        },
        {
            "type": "rich_text",
...
استراحة بصرية توضح مفهوم "نطاق التوقيت الآمن".
"""
        },
        {
            "type": "rich_text",
...
لقطة ختامية تلخص مؤشرات التوقيت الذكي الخمسة.
"""
        },
        {
            "type": "rich_text",
...
استراحة بصرية توضح الطبقات الأربع للتوزيع الذكي.
"""
        },
        {
            "type": "rich_text",
...
لقطة ختامية توضح تأثير التوزيع على الحالة النفسية.
"""
        },
        {
            "type": "rich_text",
...
استراحة بصرية توضح منظومة الإشارات الأربع للخروج الذكي.
"""
        },
        {
            "type": "rich_text",
...
لقطة ختامية توضح آلية قاعدة 48 ساعة لحماية القرار.
"""
        },
        {
            "type": "rich_text",
...
استراحة بصرية توضح أنواع الإشارات السلوكية الثلاث.
"""
        },
        {
            "type": "rich_text",
...
لقطة ختامية توضح مؤشرات "السوق السعيد جدًا" الخطيرة.
"""
        },
        {
            "type": "rich_text",
