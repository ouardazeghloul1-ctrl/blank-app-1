...
with st.expander("📁 حالة المجلدات (تشخيص)"):
    folders = {
        ...
        "reports_store/metadata": os.path.exists(METADATA_FOLDER),
        "reports_store/basic": os.path.exists(BASIC_FOLDER),
        "reports_store/pro": os.path.exists(PRO_FOLDER),
        "reports_store/premium": os.path.exists(PREMIUM_FOLDER),
    }
