...
st.markdown("""
    <div class='header-section'>
        ...
        <div class='real-data-badge'>
            🎯 بيانات سوقية حقيقية من العقار • تحديث فوري • تحليل رقمي
        </div>
        <div class='ai-badge'>
            🤖 مدعوم بالذكاء الاصطناعي • تحليل تنبؤي • قرارات رقمية     
        </div>
    </div>
""", unsafe_allow_html=True)
...
with col1:
    ...
    area = st.slider("المساحة (م²):", 50, 1000, 120, label_visibility="visible")
    property_count = st.slider("🔢 عدد العقارات للتحليل:", 50, 1000, 200, label_visibility="visible")
